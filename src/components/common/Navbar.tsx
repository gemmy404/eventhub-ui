            ...
            <div className="site-header__inner container">
                ...
                <div className="auth-navigation">
                    {isAuthenticated && user ? (
                        <>
                            <span className="auth-navigation__user">{user.name}</span>
                            <button type="button" className="auth-navigation__action" onClick={handleLogout}>
                                Logout
                            </button>
                        </>
                    ) : (
                        <>
                            <NavLink className="auth-navigation__link" to="/login">
                                Login
                            </NavLink>
                            <NavLink
                                className="auth-navigation__link auth-navigation__link--register"
                                to="/register"
                            >
                                Register
                            </NavLink>
