...
import { getAccessToken, getStoredUser, removeAccessToken, removeStoredUser, setAccessToken, setStoredUser } from '../utils/authStorage'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(() => ({ user, accessToken, isAuthenticated: Boolean(accessToken && user), isLoading, login, register, logout }), [accessToken, user, isLoading])
